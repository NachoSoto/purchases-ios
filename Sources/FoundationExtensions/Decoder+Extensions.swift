...
enum DefaultDecodable {
    ...
    enum Sources {
        ...
        enum EmptyList<T: List>: DefaultValueProvider {
            static var defaultValue: T { [] }
        }

        enum EmptyMap<T: Map>: DefaultValueProvider {
            static var defaultValue: T { [:] }
        }
 ...
 *   @DefaultDecodable.EmptyList var values: [String]
 * }
 * ```
 */
extension DefaultDecodable {
    ...
    typealias EmptyList<T: List> = DefaultValue<Sources.EmptyList<T>>
    typealias EmptyMap<T: Map> = DefaultValue<Sources.EmptyMap<T>>
