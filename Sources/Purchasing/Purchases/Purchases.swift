 ...
 */
@objc(RCPurchases) public final class Purchases: NSObject, PurchasesType {
    ...
    public static var shared: PurchasesType {
    ...
    private static let purchases: Atomic<PurchasesType?> = nil
    ...
    static func setDefaultInstance(_ purchases: PurchasesType) {
...
public extension Purchases {
    ...
    static func addAttributionData(_ data: [String: Any],
        ...
        if Self.isConfigured {
            // This is deprecated, going away in the next major version.
            // This is only unsafe if `Purchases.shared` is being mocked with a different type.
            // swiftlint:disable:next force_cast
            (Self.shared as! Purchases).post(attributionData: data,
                                             fromNetwork: network,
