...
func checkCustomerInfoAPI() {
    ...
    let entitlementValidation: EntitlementValidation = customerInfo.entitlementValidation
    ...
    print(customerInfo!, entitlementInfo, entitlementValidation, asubs, appis, led!, nst, oav!, opd!, rDate!, fSeen,
